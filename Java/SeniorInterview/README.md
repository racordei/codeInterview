...
1. Download the Problem 1 folder [clicking here](https://github.com/racordei/codeInterview/raw/main/Problems/FixTheCode/FTC_1_sorting-algorithms/java/source.zip).
